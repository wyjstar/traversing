...
from shared.db_opear.configs_data.game_configs import hero_config, hero_exp_config, base_config, \
    ...
    equipment_strengthen_config, equipment_config, link_config, sign_in_config
...
item1 = {'id': 1000101, 'funcArg1': 100000}
item2 = {'id': 1000102, 'funcArg1': 50000}
item3 = {'id': 1000103, 'funcArg1': 10000}
item4 = {'id': 1000104, 'funcArg1': 1000}

item5 = {'id': 1000112, 'func': 2, 'funcArg1': 1000113, 'funcArg2': 1, 'dropId': 10002}
...
small_bag_config_mock = SmallBagsConfig().parser([small_bag1, small_bag9, small_bag10, small_bag11, small_bag12, small_bag13])
...
# ------------------------shop----------------------------
shop1 = dict(id=1001, type=1, consume={const.COIN: [21, 21, 0]}, gain={const.COIN: [21, 21, 0]},
             extraGain={const.COIN: [20, 20, 0]}, freePeriod=24)
shop2 = dict(id=1002, type=1, consume={const.COIN: [22, 22, 0]}, gain={const.COIN: [22, 22, 0]},
             extraGain={const.COIN: [20, 20, 0]}, freePeriod=-1)
shop3 = dict(id=1003, type=5, consume={const.GOLD: [23, 23, 0]}, gain={const.COIN: [23, 23, 0]},
             extraGain={const.COIN: [20, 20, 0]}, freePeriod=72)
shop4 = dict(id=1004, type=5, consume={const.GOLD: [24, 24, 0]}, gain={const.COIN: [24, 24, 0]},
             extraGain={const.COIN: [20, 20, 0]},
             freePeriod=-1)
shop5 = dict(id=1005, type=2, consume={const.COIN: [25, 25, 0]}, gain={const.COIN: [25, 25, 0]},
             extraGain={const.COIN: [20, 20, 0]}, freePeriod=24)
shop6 = dict(id=1006, type=6, consume={const.GOLD: [26, 26, 0]}, gain={const.COIN: [26, 26, 0]},
             extraGain={const.COIN: [20, 20, 0]},
             freePeriod=48)
...
equipment_strength_1 = dict(level=1, currencyCost1=16, currencyCost2=20, currencyCost3=24, currencyCost4=40,
                            currencyCost5=69)
equipment_strength_2 = dict(level=2, currencyCost1=18, currencyCost2=21, currencyCost3=27, currencyCost4=44,
                            currencyCost5=74)
...
#------------------------sign_in_config----------------------------
sign_in1 = dict(id=1, month=8, times=26, reward={const.COIN: [1000, 1000, 0]})
sign_in2 = dict(id=2, month=8, times=27, reward={const.COIN: [1000, 1000, 0]})
sign_in3 = dict(id=3, month=8, times=28, reward={const.COIN: [1000, 1000, 0]})

sign_in_mock = SignInConfig().parser([sign_in1, sign_in2, sign_in3])
for key, value in sign_in_mock.items():
    sign_in_config[key] = value