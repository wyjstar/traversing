...
def init_line_up(player):
    # 阵容武将
    player.line_up_component.change_hero(1, 10048, 0)
    player.line_up_component.change_hero(2, 10045, 0)
    player.line_up_component.change_hero(3, 10046, 0)
    player.line_up_component.change_hero(4, 10053, 0)
    player.line_up_component.change_hero(5, 10056, 0)
    player.line_up_component.change_hero(6, 10061, 0)
    ...
    for equipment in player.equipment_component.get_all():
        ...
        if no == 100001: # 烽火之冠
            ...
            equipment.attribute.strengthen_lv = 150
        if no == 100012: # 烽火护胸
