...
_PVPFIGHTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cur_rank', full_name='PvpFightResponse.cur_rank', index=16,
