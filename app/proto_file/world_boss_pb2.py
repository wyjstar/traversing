...
_PVBRANKITEM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='head', full_name='PvbRankItem.head', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='line_up', full_name='PvbRankItem.line_up', index=4,
...
_PVBRANKITEM.fields_by_name['line_up'].message_type = line_up_pb2._LINEUPRESPONSE
