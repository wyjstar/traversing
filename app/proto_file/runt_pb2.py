...
_BUILDRUNTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='runt', full_name='BuildRuntResponse.runt', index=2,
...
_BUILDRUNTRESPONSE.fields_by_name['runt'].message_type = _RUNT1
