...
_GETESCORTTASKSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='my_protect_tasks', full_name='GetEscortTasksResponse.my_protect_tasks', index=8,
...
_GETESCORTTASKSRESPONSE.fields_by_name['my_protect_tasks'].message_type = _ESCORTTASK
