...
_GUILDBOSSINITRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='guild_skill', full_name='GuildBossInitResponse.guild_skill', index=0,
