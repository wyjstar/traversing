...
_GETGUILDINFORESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='level', full_name='GetGuildInfoResponse.level', index=30,
