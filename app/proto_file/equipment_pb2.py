...
_EQUIPMENTPB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='main_attr', full_name='EquipmentPB.main_attr', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='minor_attr', full_name='EquipmentPB.minor_attr', index=8,
