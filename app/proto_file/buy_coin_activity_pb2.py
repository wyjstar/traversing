...
_BUYCOINRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gain', full_name='BuyCoinResponse.gain', index=1,
...
_BUYCOINRESPONSE.fields_by_name['gain'].message_type = common_pb2._GAMERESOURCESRESPONSE
