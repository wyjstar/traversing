...
_GAMELOGINRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='level', full_name='GameLoginResponse.level', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='exp', full_name='GameLoginResponse.exp', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='coin', full_name='GameLoginResponse.coin', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gold', full_name='GameLoginResponse.gold', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hero_soul', full_name='GameLoginResponse.hero_soul', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='junior_stone', full_name='GameLoginResponse.junior_stone', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='middle_stone', full_name='GameLoginResponse.middle_stone', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='high_stone', full_name='GameLoginResponse.high_stone', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fine_hero', full_name='GameLoginResponse.fine_hero', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='excellent_hero', full_name='GameLoginResponse.excellent_hero', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fine_equipment', full_name='GameLoginResponse.fine_equipment', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='excellent_equipment', full_name='GameLoginResponse.excellent_equipment', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stamina', full_name='GameLoginResponse.stamina', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pvp_times', full_name='GameLoginResponse.pvp_times', index=15,
