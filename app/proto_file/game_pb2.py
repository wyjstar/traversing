...
_GAMELOGINRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_stamina_times', full_name='GameLoginResponse.get_stamina_times', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='buy_stamina_times', full_name='GameLoginResponse.buy_stamina_times', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='last_gain_stamina_time', full_name='GameLoginResponse.last_gain_stamina_time', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='soul_shop_refresh_times', full_name='GameLoginResponse.soul_shop_refresh_times', index=24,
