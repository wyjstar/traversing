...
_GAMELOGINREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pf', full_name='GameLoginRequest.pf', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pfkey', full_name='GameLoginRequest.pfkey', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='zoneid', full_name='GameLoginRequest.zoneid', index=24,
