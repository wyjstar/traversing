...
_GAMELOGINRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pvp_overcome_index', full_name='GameLoginResponse.pvp_overcome_index', index=32,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pvp_overcome_refresh_count', full_name='GameLoginResponse.pvp_overcome_refresh_count', index=33,
