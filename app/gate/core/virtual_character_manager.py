...
class VCharacterManager:
    ...
    def add_character(self, v_character):
        """添加一个虚拟角色
        """
        self.character_client[v_character.character_id] = v_character
        self.client_character[v_character.dynamic_id] = v_character.character_id
    ...
    def get_node_by_id(self, character_id):
        character = self.get_by_id(character_id)
        if character:
