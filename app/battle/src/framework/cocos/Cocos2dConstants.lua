...
cc.SHADER_POSITION_TEXTURE_GRAY = 'ShaderPositionTextureGray'
cc.SHADER_POSITION_TEXTURE_GRAYP = 'ShaderPositionTextureGrayP'
...
cc.ASSETSMANAGER_NOZIPFILE     = 4

cc.ASSETSMANAGER_PROTOCOL_PROGRESS =  0
cc.ASSETSMANAGER_PROTOCOL_SUCCESS  =  1
cc.ASSETSMANAGER_PROTOCOL_ERROR    =  2

cc.ASSETSDOWNLOADER_CREATE_FILE  = 0
cc.ASSETSDOWNLOADER_NETWORK = 1
cc.ASSETSDOWNLOADER_UNCOMPRESS = 2

cc.ASSETSDOWNLOADER_PROTOCOL_PROGRESS =  0
cc.ASSETSDOWNLOADER_PROTOCOL_SUCCESS  =  1
cc.ASSETSDOWNLOADER_PROTOCOL_ERROR    =  2
...
cc.Handler.ASSETSDOWNLOADER_PROGRESS= 34
cc.Handler.ASSETSDOWNLOADER_SUCCESS = 35
cc.Handler.ASSETSDOWNLOADER_ERROR   = 36

cc.Handler.STUDIO_EVENT_LISTENER  = 37
cc.Handler.ARMATURE_EVENT         = 38

cc.Handler.EVENT_ACC              = 39
cc.Handler.EVENT_CUSTIOM          = 40

cc.Handler.EVENT_KEYBOARD_PRESSED = 41
cc.Handler.EVENT_KEYBOARD_RELEASED = 42

cc.Handler.EVENT_TOUCH_BEGAN      = 43
cc.Handler.EVENT_TOUCH_MOVED      = 44
cc.Handler.EVENT_TOUCH_ENDED      = 45
cc.Handler.EVENT_TOUCH_CANCELLED  = 46

cc.Handler.EVENT_TOUCHES_BEGAN    = 47
cc.Handler.EVENT_TOUCHES_MOVED    = 48
cc.Handler.EVENT_TOUCHES_ENDED    = 49
cc.Handler.EVENT_TOUCHES_CANCELLED = 50

cc.Handler.EVENT_MOUSE_DOWN       = 51
cc.Handler.EVENT_MOUSE_UP         = 52
cc.Handler.EVENT_MOUSE_MOVE       = 53
cc.Handler.EVENT_MOUSE_SCROLL     = 54

cc.Handler.EVENT_SPINE            = 55

cc.Handler.EVENT_PHYSICS_CONTACT_BEGIN = 56
cc.Handler.EVENT_PHYSICS_CONTACT_PRESOLVE = 57
cc.Handler.EVENT_PHYSICS_CONTACT_POSTSOLVE = 58
cc.Handler.EVENT_PHYSICS_CONTACT_SEPERATE = 59
