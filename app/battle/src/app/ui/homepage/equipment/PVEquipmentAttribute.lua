...
local PVEquipmentAttribute = class("PVEquipmentAttribute", BaseUIView)
g_seat = nil
g_equipData = nil

function PVEquipmentAttribute:ctor(id)
    PVEquipmentAttribute.super.ctor(self, id)

    self.lineupData = getDataManager():getLineupData()
    self.c_Calculation = getCalculationManager():getCalculation()
end

function PVEquipmentAttribute:onMVCEnter()
...
-- 获取控件与设置属性
function PVEquipmentAttribute:initView()
...
function PVEquipmentAttribute:initData()
...
function PVEquipmentAttribute:setChageModel(flag)
...
function PVEquipmentAttribute:initTouchListener()
...
function PVEquipmentAttribute:createScrollView()
...
function PVEquipmentAttribute:createBasicAttribute()
...
function PVEquipmentAttribute:initHeroLayerTouch()
...
function PVEquipmentAttribute:onLayerTouchCallBack(moveType)
...
--往左滑动
function PVEquipmentAttribute:OnTouchMoveLeft()
    if self.curPage == 1 then
...
--往右滑动
function PVEquipmentAttribute:OnTouchMoveRight()
