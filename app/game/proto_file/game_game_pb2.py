...
_ADDEQUIPMENTREQUEST = _descriptor.Descriptor(
  name='AddEquipmentRequest',
  full_name='proto_file.game.AddEquipmentRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='equipmentId', full_name='proto_file.game.AddEquipmentRequest.equipmentId', index=0,
...
_ADDEQUIPMENTRESPONSE = _descriptor.Descriptor(
  name='AddEquipmentResponse',
  full_name='proto_file.game.AddEquipmentResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='equipmentId', full_name='proto_file.game.AddEquipmentResponse.equipmentId', index=0,
      number=1, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='proto_file.game.AddEquipmentResponse.message', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='result', full_name='proto_file.game.AddEquipmentResponse.result', index=2,
...
DESCRIPTOR.message_types_by_name['AddEquipmentRequest'] = _ADDEQUIPMENTREQUEST
DESCRIPTOR.message_types_by_name['AddEquipmentResponse'] = _ADDEQUIPMENTRESPONSE
...
class AddEquipmentRequest(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ADDEQUIPMENTREQUEST

  # @@protoc_insertion_point(class_scope:proto_file.game.AddEquipmentRequest)

class AddEquipmentResponse(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ADDEQUIPMENTRESPONSE

  # @@protoc_insertion_point(class_scope:proto_file.game.AddEquipmentResponse)
